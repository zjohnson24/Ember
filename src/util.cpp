...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Ember
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Ember
    // Mac: ~/Library/Application Support/Ember
    // Unix: ~/.Ember
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ember";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Ember.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Emberd.pid"));
