...
Value getinfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("moneysupply",   (((double)(pindexBest->nMoneySupply)) / (double)COIN)));
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress <Emberaddress>\n"
            "Return information about <Emberaddress>.");
...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error(
            "validatepubkey <Emberpubkey>\n"
            "Return information about <Emberpubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage <Emberaddress> <signature> <message>\n"
